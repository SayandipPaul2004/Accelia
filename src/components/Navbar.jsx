          ...
          <div className="relative flex items-center justify-between h-16 sm:h-20 md:h-20">
            ...
            <div className="flex items-center gap-4 z-10 ml-auto">
              ...
              >
                <Link
                  href="/contact"
                  className="flex items-center gap-2.5 bg-white text-slate-950 font-semibold text-[15px] lg:text-base pl-5 pr-1.5 py-1.5 rounded-full hover:bg-white/90 transition-colors"
                >
                  Let&apos;s Connect
                  <span className="flex items-center justify-center w-8 h-8 rounded-full bg-[#2547d0] text-white">
                    <svg
                      width="14"
                      height="14"
                      viewBox="0 0 24 24"
      ...
      <AnimatePresence>
        {mobileOpen && (
          ...
          >
            ...
            >
              <div className="flex flex-col h-full px-7 sm:px-9 pt-24 pb-10 overflow-y-auto">
